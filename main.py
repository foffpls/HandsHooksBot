...
async def cmd_start(message: types.Message):
    await message.answer('Привіт, шукачу! \n'
                         ...
                         'Отже, коротко і по ділу. Уже дещо я вмію. Дещо можу ще навчитись. Якщо хочеш моєї допомоги - користуйся меню, яке я спеціально створив для тебе (воно нижче). '
                         'Якщо хочеш мене чогось навчити - пиши сюди: @foff_pls.\n\n'
